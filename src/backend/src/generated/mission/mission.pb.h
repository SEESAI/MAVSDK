...
class ImportQgroundcontrolMissionRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_qgc_plan_path(
...
inline std::string* ImportQgroundcontrolMissionRequest::unsafe_arena_release_qgc_plan_path() {
  // @@protoc_insertion_point(field_unsafe_arena_release:mavsdk.rpc.mission.ImportQgroundcontrolMissionRequest.qgc_plan_path)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return qgc_plan_path_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ImportQgroundcontrolMissionRequest::unsafe_arena_set_allocated_qgc_plan_path(
  ...
  qgc_plan_path_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      qgc_plan_path, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:mavsdk.rpc.mission.ImportQgroundcontrolMissionRequest.qgc_plan_path)
}
...
inline void MissionResult::unsafe_arena_set_allocated_result_str(
    std::string* result_str) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (result_str != nullptr) {
