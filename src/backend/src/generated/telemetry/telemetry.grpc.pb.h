    ...
    ExperimentalWithCallbackMethod_SubscribeVehicleStatus() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(15,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::mavsdk::rpc::telemetry::SubscribeVehicleStatusRequest, ::mavsdk::rpc::telemetry::VehicleStatusResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
    ...
    ExperimentalWithCallbackMethod_SubscribeServoOutputRaw() {
      ...
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(23,
          new ::grpc_impl::internal::CallbackServerStreamingHandler< ::mavsdk::rpc::telemetry::SubscribeServoOutputRawRequest, ::mavsdk::rpc::telemetry::ServoOutputRawResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
