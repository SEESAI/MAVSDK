...
public:
    ...
    void subscribe_gps_input(Telemetry::GpsInputCallback& callback);
    ...
    void subscribe_landing_target_position(Telemetry::LandingTargetPositionCallback& callback);
...
private:
    ...
    Telemetry::GpsInputCallback _gps_input_subscription{nullptr};
    ...
    Telemetry::LandingTargetPositionCallback _landing_target_position_subscription{nullptr};
