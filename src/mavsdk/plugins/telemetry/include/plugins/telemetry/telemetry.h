...
public:
    ...
    struct GpsInput {
        ...
        float vdop{}; /**< @brief GPS VDOP vertical dilution of position (unitless). If unknown, set
                         to NaN */
        float
            velocity_n_m_s{}; /**< @brief GPS Velocity along north direction in metres per second */
        float
            velocity_e_m_s{}; /**< @brief GPS Velocity along east direction in metres per second */
        float
            velocity_d_m_s{}; /**< @brief GPS Velocity along down direction in metres per second */
        float horizontal_uncertainty_m{}; /**< @brief Position uncertainty in metres */
        float vertical_uncertainty_m{}; /**< @brief Altitude uncertainty in metres */
    ...
    struct VehicleStatus {
        ...
        uint32_t mavlink_count{0}; /**< @brief Number of Mavlink connections providing setpoints
                                      (implying joystick connected). Should be < 2.*/
        uint32_t rc_count{0}; /**< @brief Number of RC connections providing setpoints (implying
                                 joystick connected). Should be < 2.*/
        uint32_t sees_desired_control_source{
            0}; /**< @brief Desired type of manual control source, RC (1) or Mav (2)  */
    };
    ...
    /**
     * @brief Handle type for subscribe_gps_2_info.
     */
    using Gps2InfoHandle = Handle<GpsInfo>;

    /**
     * @brief Subscribe to 'GPS 2 info' updates.
     */
    Gps2InfoHandle subscribe_gps_2_info(const Gps2InfoCallback& callback);

    /**
     * @brief Unsubscribe from subscribe_gps_2_info
     */
    void unsubscribe_gps_2_info(Gps2InfoHandle handle);
    ...
    /**
     * @brief Handle type for subscribe_raw_gps_2.
     */
    using RawGps2Handle = Handle<RawGps>;

    /**
     * @brief Subscribe to 'Raw GPS 2' updates.
     */
    RawGps2Handle subscribe_raw_gps_2(const RawGps2Callback& callback);
    ...
    /**
     * @brief Handle type for subscribe_gps_input.
     */
    using GpsInputHandle = Handle<GpsInput>;

    /**
     * @brief Subscribe to 'GPS Input' updates.
     */
    GpsInputHandle subscribe_gps_input(const GpsInputCallback& callback);

    /**
     * @brief Unsubscribe from subscribe_gps_input
     */
    void unsubscribe_gps_input(GpsInputHandle handle);
    ...
    /**
     * @brief Handle type for subscribe_gps_rtcm_data.
     */
    using GpsRtcmDataHandle = Handle<GpsRtcmData>;

    /**
     * @brief Subscribe to 'GPS RTCM' updates.
     */
    GpsRtcmDataHandle subscribe_gps_rtcm_data(const GpsRtcmDataCallback& callback);

    /**
     * @brief Unsubscribe from subscribe_gps_rtcm_data
     */
    void unsubscribe_gps_rtcm_data(GpsRtcmDataHandle handle);
