...
public:
    ...
    struct Battery {
        ...
        float mah_consumed{float(NAN)}; /**< @brief Current consumed in mAh s*/
    };
     ...
     */
    struct RadioStatus {
        uint32_t local_rssi; /**< @brief Local (message sender) received signal strength indication in device-dependent units/scale. */
        uint32_t remote_rssi; /**< @brief Remote (message receiver) signal strength in device-dependent units/scale. */
        float remaining_free_txbuf; /**< @brief Remaining percentage of free transmitter buffer space. */
        uint32_t local_noise; /**< @brief Local background noise level. These are device dependent RSSI values. */
        uint32_t remote_noise; /**< @brief Remote background noise level. These are device dependent RSSI values. */
