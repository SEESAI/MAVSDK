...
void SystemImpl::process_heartbeat(const mavlink_message_t& message)
{
    ...
    set_heartbeat_base_mode(heartbeat.base_mode);
    set_heartbeat_custom_mode(heartbeat.custom_mode);
...
void SystemImpl::set_heartbeat_base_mode(uint8_t heartbeat_base_mode)
{
    _heartbeat_base_mode = heartbeat_base_mode;
}
...
void SystemImpl::set_heartbeat_custom_mode(uint32_t heartbeat_custom_mode)
{
    _heartbeat_custom_mode = heartbeat_custom_mode;
}
